...
export class EstudianteService {
  ...
  //ese codigo comentado sirve para manipular mas ordenado
  ...
  resgistarAsignatura(estudiante:Estudiante): Observable<any>{
    ...
    return this.http.post<Estudiante>(this.api+"/Asignatura/registrar", estudiante,{headers:this.HttHeaders})
